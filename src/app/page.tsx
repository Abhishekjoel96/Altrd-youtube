    ...
    <div className="min-h-screen bg-white dark:bg-[#121212] text-black dark:text-white">
      ...
      <header className="bg-gray-50 dark:bg-[#121212] py-4 px-6 border-b border-gray-200 dark:border-[#333333] flex items-center justify-between">
        <div className="flex items-center">
          <div className="bg-[#FF6500] text-[#121212] h-10 w-10 flex items-center justify-center rounded-md mr-2">
            <Package className="h-6 w-6" />
          </div>
          <h1 className="text-xl font-bold">Altrd Labs Youtube Clipper</h1>
        </div>
        <ThemeToggle />
      </header>
        ...
        <div className="flex max-w-4xl mx-auto">
          <button
            ...
            className={`px-6 py-3 font-medium text-sm ${
              activeTab === "clipper"
                ? "border-b-2 border-[#FF6500] text-[#FF6500]"
        ...
        {!videoLoaded && activeTab === "clipper" && (
          <div className="bg-gray-50 dark:bg-[#1E1E1E] rounded-lg p-8 mb-8 text-center">
            <h2 className="text-4xl font-bold mb-4">
              Build, share and <span className="text-[#FF6500]">monetize</span>
            </h2>
            ...
            <Button className="bg-[#FF6500] text-[#121212] hover:bg-[#E55A00] py-2 px-6">
              Get Started Free
            </Button>
          </div>
        )}
